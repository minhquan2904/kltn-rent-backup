...
var ApiService = (function () {
    ...
    ApiService.prototype.resetImg = function () {
        var _this = this;
        var session = JSON.parse(localStorage.getItem('sessionImg'));
        Object.keys(session).forEach(function (item) {
            console.log(session[item]);
            _this.deleteImg(session[item]).subscribe(function (res) {
                console.log(res);
            }, function (err) {
                console.log(err);
            });
        ...
        if (this.apiService.sessionExpired) {
            ...
            if (this.motel.city === undefined || this.motel.district === undefined || this.motel.ward === undefined
                ...
                this.motelService.create(this.motel).then(function (data) {
                    _this.apiService.listImg = []; // reset img session
                    localStorage.setItem('sessionImg', '{}');
                    _this.apiService.resetImg(); // reset variable session
    ...
    function DialogOverviewExampleDialog(dialogRef, data, alertService, apiService) {
        ...
        this.uploader.onCompleteItem = function (item, response, status) {
            ...
            if (status === 200) {
                ...
                var ssImg = JSON.parse(localStorage.getItem('sessionImg'));
...
module.exports = "<app-nav></app-nav>\n\n<div class=\"temp\"></div>\n    <alert></alert>\n      <div class=\"wrapper\">\n        <div>\n          <div class=\"img-wrapper\">\n            <div></div>\n            <div>\n              <!-- TAB IMG + MAP -->\n                <mat-tab-group>\n                    <mat-tab [label]=\"'PAGE.PIC' | translate\">\n                      <!-- MOTEL IMAGE -->\n                      <!-- <div *ngFor=\"let item of img\">\n                        {{item}}\n                      </div> -->\n                      <div id=\"myCarousel\" class=\"carousel slide\" data-ride=\"carousel\">\n                        <!-- Indicators -->\n                        <ol class=\"carousel-indicators\">\n                          <li data-target=\"#myCarousel\" *ngFor=\"let item of img; let i = index\" [attr.data-slide-to]=\"i\" ngClass=\"i == 0 ? 'active' : ''\"></li>\n                        </ol>\n                    \n                        <!-- Wrapper for slides -->\n                        <div class=\"carousel-inner\">\n                          <div *ngFor=\"let j of img; let k = index\" [ngClass]=\"k == 0 ? 'item active' : 'item'\">\n                            <img src=\"/assets/{{img[k]}}\" alt=\"Event Image\" class=\"img-responsive\" onError=\"this.src='http://www.wellesleysocietyofartists.org/wp-content/uploads/2015/11/image-not-found.jpg'\" >\n                        </div>\n                        \n                          \n                        </div>\n                    \n                        <!-- Left and right controls -->\n                        <a class=\"left carousel-control\" href=\"#myCarousel\" data-slide=\"prev\">\n                          <span class=\"glyphicon glyphicon-chevron-left\"></span>\n                          <span class=\"sr-only\">{{'HOME.PREVIOUS'}}</span>\n                        </a>\n                        <a class=\"right carousel-control\" href=\"#myCarousel\" data-slide=\"next\">\n                          <span class=\"glyphicon glyphicon-chevron-right\"></span>\n                          <span class=\"sr-only\">{{'HOME.NEXT'}}</span>\n                        </a>\n                      </div>\n                   \n                      \n                      </mat-tab>\n                      <mat-tab #mapTab [label]=\"'PAGE.MAP' | translate\">\n                          <div *ngIf=\"mapTab.isActive\">\n                            <app-map-service [myData]=\"data\"></app-map-service>\n                          </div>\n                      </mat-tab>\n                </mat-tab-group>\n              \n            </div>\n            <div></div>\n          </div>\n          <!-- ADMIN  -->\n          <div *ngIf=\"authService.isAdmin === true || authService.isSuperAdmin === true\">\n              <div class=\"text-center\">\n                  <alert></alert>\n              </div>\n              <div class=\"admin-wrapper\" >\n             \n                  <div></div>\n                  <div *ngIf=\"motel.status === 0\">\n                    <button mat-raised-button color=\"primary\" style=\"float: right;\" (click)=\"handleUpdateStatus(1)\">{{ 'ADMIN.ACCEPT' | translate}}</button>\n                  </div>\n                  <div>\n                    <button mat-raised-button color=\"warn\" (click)=\"handleUpdateStatus(-1)\" *ngIf=\"motel.status === 0 || motel.status === 1\">{{ 'ADMIN.DELETE' | translate}}</button>\n                    <button mat-raised-button color=\"acent\" (click)=\"backClicked()\">{{ 'ADMIN.BACK' | translate}}</button>                \n                  </div>\n                  <div></div>\n              </div>\n          </div>\n          \n          <!-- MOTEL INFOMATION -->\n          <div class=\"info-wrapper\">\n              <!-- Description -->\n              <div></div>\n             <div>\n                <div class=\"descripsion\">\n                    <h4 class=\"mt-4\">{{'PAGE.DESCRIPTION' | translate}}</h4>\n                    {{motel.description}}   \n                </div>\n             </div>\n             <!-- Address  -->\n             <div>\n                <div class=\"address\">\n                    <address>\n                        <h4>{{'PAGE.ADDRESS' | translate}}</h4>\n                        <strong>{{motel.district}}, {{motel.city}} </strong>\n                        <br>{{motel.add}}, {{motel.street}}\n                        <br>{{motel.ward}}\n                        <br>\n                      </address>\n                </div>\n                <div class=\"contact\">\n                    {{'PAGE.CONTACT' | translate}} : {{motel.contact}}\n                </div>\n                <button mat-icon-button color=\"warn\"  (click)=\"onNavigate()\">           \n                  <mat-icon aria-label=\"Example icon-button with a heart icon\">room</mat-icon>\n                  {{'PAGE.SHOW_GOOGLE_MAP' | translate}}\n              </button>\n             </div>\n             <div></div>\n           </div>\n       \n          </div>\n\n         \n        <!-- USER INFO -->\n        <div class=\"user-info\">\n          <app-user-info [myData]=\"user\"></app-user-info>\n        </div>\n        <!-- COMMENT AREA -->\n        \n        \n        <div class=\"user-info-mobile\">\n            <div></div>\n            \n            <div>\n                <button mat-raised-button color=\"primary\" (click)=\"openDialog()\">Show contact info</button>\n            </div>\n\n            <div>\n              \n            </div>\n        </div>\n      </div>\n      <div class=\"cmt-wrapper\">\n        <div></div>\n        <div><app-comment-box  [motelID]=\"motel_id\"></app-comment-box></div>\n        <div></div>\n      </div>\n      <div class=\"comment-wrapper\">\n        <div></div>\n        <div>\n            <div style=\"height:20px;\"> </div> \n            <div>\n              <!-- comment list -->\n              <app-comment-list></app-comment-list>\n            </div>\n            \n        </div>\n        <div></div>\n          \n      </div>\n<app-footer></app-footer>"
...
var ItemComponent = (function () {
    function ItemComponent(_location, dialog, router, authService, route, motelService, alertService) {
    ...
    ItemComponent.prototype.backClicked = function () {
        this._location.back();
    };
    ItemComponent.prototype.handleUpdateStatus = function (status) {
        var _this = this;
        ...
        this.motelService.update(this.motel_id, motel).subscribe(function (res) {
            _this.motel.status = status;
    ...
    ItemComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__angular_common__["Location"], __WEBPACK_IMPORTED_MODULE_3__angular_material__["i" /* MatDialog */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */], __WEBPACK_IMPORTED_MODULE_2__services_index__["c" /* AuthenticationService */],
...
module.exports = "<app-nav></app-nav>\n<div class=\"container\">\n    <div class=\"row\">\n            <mat-tab-group>\n                <mat-tab [label]=\"'HOME.SEARCH_ADDRESS' | translate\"> \n                    <mat-form-field class=\"col-sm-3\">\n                        <mat-select [placeholder]=\"'HOME.CITY' | translate\"  (change)=\"onCityChange();\" [(ngModel)]=\"city.id\" #id=\"ngModel\" [ngModelOptions]=\"{standalone: true}\">\n                          <mat-option *ngFor=\"let item of resultArray; let i = index\" [value]=\"i\">\n                            {{ item.name }}\n                          </mat-option>\n                        </mat-select>\n                    </mat-form-field>\n                \n                    <mat-form-field class=\"col-sm-3\">\n                        <mat-select [placeholder]=\"'HOME.DISTRICT' | translate\" [(ngModel)]=\"query.district\" #district=\"ngModel\" [ngModelOptions]=\"{standalone: true}\">\n                            <mat-option *ngFor=\"let item of districtArray; let i = index\" [value]=\"item\"  >\n                            {{ item }}\n                            </mat-option>\n                        </mat-select>\n                    </mat-form-field>\n                \n                    <mat-form-field class=\"col-sm-3\">\n                        <input matInput [placeholder]=\"'HOME.WARD' | translate\" [(ngModel)]=\"query.ward\" #ward=\"ngModel\" [ngModelOptions]=\"{standalone: true}\">\n                        <mat-hint>{{ 'HOME.ONLY_WARD' | translate }}</mat-hint>\n                    </mat-form-field>\n                    <mat-form-field class=\"col-sm-3\">\n                        <input matInput [placeholder]=\"'HOME.STREET' | translate\" [(ngModel)]=\"query.street\" #street=\"ngModel\" [ngModelOptions]=\"{standalone: true}\">\n                        <mat-hint>{{ 'HOME.ONLY_STREET' | translate }}</mat-hint>\n                    </mat-form-field>\n               \n                    <div class=\"col-sm-12\" style=\"display: inline;\">\n                            {{ 'HOME.PRICE' | translate }}\n                        <mat-form-field>\n                            <input matInput [placeholder]=\"'HOME.FROM' | translate\" [(ngModel)]=\"query.bottom_price\" #bottomPrice=\"ngModel\" [ngModelOptions]=\"{standalone: true}\">\n                        </mat-form-field>\n                        -\n                        <mat-form-field>\n                            <input matInput [placeholder]=\"'HOME.TO' | translate\" [(ngModel)]=\"query.top_price\" #topPrice=\"ngModel\" [ngModelOptions]=\"{standalone: true}\">\n                        </mat-form-field>\n                        <mat-hint>VND {{ 'HOME.PER_MONTH' | translate}}</mat-hint>\n                    </div>\n                    <div class=\"col-sm-6\">\n                        <button mat-raised-button color=\"primary\" (click)=\"onAdvanceSearch()\"><mat-icon>search</mat-icon>Search</button>\n                    </div></mat-tab>\n                <mat-tab [label]=\"'HOME.SEARCH_MAP' | translate\" #mapTab>\n                        <div *ngIf=\"mapTab.isActive\">\n                            <app-map-marker-move (locationChild)=\"onMapSearchClick($event)\"></app-map-marker-move>\n                        </div>\n                </mat-tab>\n            </mat-tab-group>\n           \n    </div>\n   <app-recent-post *ngIf=\"hasRs\" [motels]=\"motels\" [title]=\"title\"></app-recent-post>\n\n</div>\n<div style=\"margin-top: 200px;\">\n\n<app-footer ></app-footer>\n    \n</div>\n"
...
module.exports = "<footer class=\"footer-distributed\">\n\n  <div class=\"footer-left\">\n\n    <h3>RentYour<span>Home</span></h3>\n\n    <p class=\"footer-links\">\n      <a href=\"#\">{{ 'PAGE.HOME' | translate}}</a>\n      ·\n      <a href=\"#\">{{ 'PAGE.BLOG' | translate}}</a>\n      ·\n      <a href=\"#\">{{ 'PAGE.PRICING' | translate}}</a>\n      ·\n      <a href=\"#\">{{ 'PAGE.ABOUT' | translate}}</a>\n      ·\n      <a href=\"#\">{{ 'PAGE.CONTACT' | translate}}</a>\n    </p>\n\n    <p class=\"footer-company-name\">UTE&copy; 2018</p>\n  </div>\n\n  <div class=\"footer-center\">\n\n    <div>\n      <i class=\"fa fa-map-marker\"></i>\n      <p><span>\n        01 {{ 'PAGE.VVN' | translate}}</span>{{ 'PAGE.LC' | translate}}, {{ 'PAGE.DThuDuc' | translate}}, {{ 'PAGE.HCM' | translate}}</p>\n    </div>\n\n    <div>\n      <i class=\"fa fa-phone\"></i>\n      <p>+84 962 123 874</p>\n    </div>\n\n    <div>\n      <i class=\"fa fa-envelope\"></i>\n      <p><a href=\"mailto:support@company.com\">14110162@student.hcmute.edu.vn</a></p>\n    </div>\n\n  </div>\n\n  <div class=\"footer-right\">\n\n    <p class=\"footer-company-about\">\n      <span>{{ 'PAGE.ABOUT_TEAM' | translate}}</span>\n      {{ 'PAGE.ABOUT_TEAM_DES' | translate}}\n    </p>\n\n\n  </div>\n\n</footer>\n"
...
var RecentPostComponent = (function () {
    ...
    function RecentPostComponent(translate) {
        this.translate = translate;
        this.p = 1;
        // list motel
        this.data = {};
...
module.exports = "<section id=\"home\" class=\"home\">\n  <div class=\"home_overlay\">\n      <div class=\"container\">\n          <div class=\"row\">\n              <div class=\"main_slider_area\">\n                  <div class=\"slider\">\n                      <div class=\"single_slider\">\n                          <p class=\"home-title\">{{ 'HOME.TITLE' | translate}}</p>\n                          <p>{{ 'HOME.MODERN' | translate}}  -  {{ 'HOME.FAST' | translate}}  -  {{ 'HOME.RELIABLE' | translate}}</p>\n                          \n                          <div class=\"col-sm-8 col-sm-offset-2\">\n                              <div class=\"home_searce_domain_area\">\n                                  <div class=\"input-search\">\n                                      <mat-form-field>\n                                        <input type=\"text\" matInput [placeholder]=\"'HOME.TYPE_TEXT' | translate\" [(ngModel)] = \"query\">\n                                      </mat-form-field>\n                                          \n                                            \n                                     \n                                      <button mat-raised-button (click)=\"onSearchClick()\" color=\"primary\"><mat-icon>search</mat-icon> {{ 'HOME.SEARCH' | translate}}</button>\n                                      <button mat-raised-button color=\"warn\" [routerLink]=\"['/advance']\"><mat-icon>assignment</mat-icon> {{ 'HOME.ADVANCE' | translate}}</button>\n                                  </div>\n                              </div>\n                          </div>\n                      </div>\n\n                  </div>\n              </div>\n          </div>\n      </div>\n  </div>\n</section><!-- End of Banner Section -->\n<app-recent-post [motels] = \"motels\" [title]=\"title\" *ngIf=\"hasRs\"></app-recent-post>"
